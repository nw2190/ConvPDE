...
def plot_prediction(ID, vals, scale, soln_dir, mesh_dir, Model=0, CV=1, Rm_Outliers=False, Filter=True, Plot_Error=True, SHOW_PLOT=True, default_res=128, refine=1, slice_plot=False, use_hires=False, save_plots=False, view_elev=30, view_angle=0):
    ...
    if use_hires:
        mesh_label = 'hires_mesh_' + str(0)
    else:
        mesh_label = 'mesh_' + str(0)
...
def plot_data(source_ID):
    data_file = './Data/data_' + str(source_ID) + '.npy'
