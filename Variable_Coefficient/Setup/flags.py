...
def getFlags():
    ...
    parser.add_argument("--use_default_res", default=True, action="store_true", help="Use standard data resolution for tfrecords")
    ...
    parser.add_argument("--solver_pools", default=50, type=int, help="Number of pools for solver to avoid memory accumulation")
    ...
    # Specify whether source term (default) or stiffness term is being sampled
    parser.add_argument("--gen_stiffness", default=False, action="store_true", help="Specify to generate stiffness term")
    ...
    parser.add_argument("--data_count", default=5000, type=int, help="Number of data samples for each covariance matrix")
