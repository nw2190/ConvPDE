...
def add_default_args(parser):
    ...
    parser.add_argument("--stopping_size", default=2000, type=int, help="Batch size for early stopping checks")
...
def getFlags():
    ...
    # Flip
    """
    parser.add_argument("--learning_rate", default=.00225, type=float, help="Initial learning rate")
    parser.add_argument("--lr_decay_step", default=1250, type=int, help="Learning rate decay step")
    parser.add_argument("--lr_decay_rate", default=0.9, type=float, help="Learning rate decay rate")
    parser.add_argument("--dropout_rate", default=0.025, type=float, help="Dropout rate for dense connections")
    parser.add_argument("--rotate", default=False, type=bool, help="Option to rotate dataset for data augmentation")
    parser.add_argument("--flip", default=True, type=bool, help="Option to flip dataset for data augmentation")
    parser.add_argument("--dataset_step", default=4, type=int, help="Step between dataset cycles")
    """
    ...
    parser.add_argument("--lr_decay_step", default=1250, type=int, help="Learning rate decay step")
    parser.add_argument("--lr_decay_rate", default=0.85, type=float, help="Learning rate decay rate")
    parser.add_argument("--dropout_rate", default=0.0, type=float, help="Dropout rate for dense connections")
    #parser.add_argument("--rotate", default=True, type=bool, help="Option to rotate dataset for data augmentation")
    #parser.add_argument("--dataset_step", default=4, type=int, help="Step between dataset cycles")
    ...
    # Batches per epoch  =  0.8*50000/45
    parser.add_argument("--batches_per_epoch", default=900, type=int, help="Number of batches in a single epoch")
    ...
    # VAE hyperparameters
    #parser.add_argument("--z_dim", default=125, type=int, help="Dimension of noise vector in latent space")
    ...
    #parser.add_argument("--early_stopping_tol", default=0.0009, type=float, help="Tolerance for early stopping")
    #parser.add_argument("--early_stopping_tol", default=0.000775, type=float, help="Tolerance for early stopping")
    ...
    # Original KL of 0.5 divided by z_dim = 200 and batch_size = 45
    parser.add_argument("--kl_weight", default=0.000053333, type=float, help="Weight for kl loss")
