...
def gen_mesh(resolution, vertex_min, vertex_max, mesh_resolution, mesh_directory, ID, coarse_resolution):
    ...
    if pixel_count < min_pixels:
        ...
        gen_mesh(resolution, vertex_min, vertex_max, mesh_resolution, mesh_directory, ID, coarse_resolution)
...
def gen_mesh_batch(resolution, vertex_min, vertex_max, mesh_resolution, mesh_dir, data_count, current_data, coarse_res):

    # Reset random seed from parent process
    np.random.seed(seed=current_data)
    
    for n in range(current_data,current_data + data_count):
        gen_mesh(resolution, vertex_min, vertex_max, mesh_resolution, mesh_dir, n, coarse_res)
