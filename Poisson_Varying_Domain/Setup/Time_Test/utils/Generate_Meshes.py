...
if __name__ == '__main__':
    ...
    def mesh_batch(d):
        gen_mesh_batch(FLAGS.resolution, FLAGS.vertex_min, FLAGS.vertex_max + 1, FLAGS.mesh_resolution, FLAGS.mesh_dir, int(FLAGS.data_count/subdivision), d, FLAGS.coarse_resolution)
