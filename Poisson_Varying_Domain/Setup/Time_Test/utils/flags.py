...
def getFlags():
    ...
    ### CHANGED ###
    parser.add_argument("--data_count", default=500, type=int, help="Number of data samples for each covariance matrix")
    ...
    parser.add_argument("--coarse_resolution", default=10, type=int, help="Coarse resolution for FEniCS solver")
