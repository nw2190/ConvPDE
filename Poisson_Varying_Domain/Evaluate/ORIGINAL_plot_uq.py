...
def main(LAPLACE=False, CAUCHY=False):
    ...
    if LAPLACE:
        ...
        ## EMPIRICAL BIAS
        normal_scaling = 2.*0.8
        func_2 = lambda x: 100.*special.erf(x/2.*normal_scaling/np.sqrt(2))
    ...
    if LAPLACE or CAUCHY:
        plt.plot(stds, func_2(stds), 'k--', linewidth=2, alpha=0.5, zorder=0, label=None)
