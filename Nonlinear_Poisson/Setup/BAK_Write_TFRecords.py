...
def write_tfrecords(indices, start_file_count, file_count, data_dir="./", tfrecord_dir="./", training=True, examples_per_file=5000):
...
if __name__ == '__main__':
    ...
    def write(d):
        write_tfrecords(d[0], d[1], d[2], data_dir="./", tfrecord_dir=FLAGS.tfrecord_dir, training=d[3], examples_per_file=examples_per_file)
