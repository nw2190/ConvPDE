...
if __name__ == '__main__':
    ...
    FLAGS.data_count = FLAGS.time_count*FLAGS.data_count
    ...
    def sample(d):
        ...
        gen_soln(d, int(FLAGS.data_count/subdivision), FLAGS.resolution, FLAGS.mesh_resolution, FLAGS.save_solutions, FLAGS.coarse_mesh)
    ...
    with open(filename, 'a') as csvfile:
        ...
        csvfile.write("%d %.7f %.7f\n" %(FLAGS.time_count*1000,total_time, average_time))
